...
<div class="container text-center my-4  all-product mb-4">
    <div class="row mx-auto my-auto">
        ...
        <!-- <div class="navbar d-flex align-items-center ml-auto navbar-1 pr-0" style="">
            <ul class="nav nav-pills  container-fluid  pr-0" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-item1-tab" data-toggle="pill" href="#pills-item1" role="tab" aria-controls="pills-item1" aria-selected="true">Thể loại 1</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-item2-tab" data-toggle="pill" href="#pills-item2" role="tab" aria-controls="pills-item2" aria-selected="false">Thể loại 2</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-item2-tab" data-toggle="pill" href="#pills-item3" role="tab" aria-controls="pills-item3" aria-selected="false">Thể loại 3</a>
                </li>
                <li class="nav-item">
    ...
    <!--menu header offer product of every category -->
    <div class="row mx-auto my-auto">



        <!-- 992px -->
        <div class="navbar d-flex align-items-center mr-auto navbar-1 pl-0" style="">
            <ul class="nav nav-pills  container-fluid  pr-0" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-item1-tab" data-toggle="pill" href="#pills-item1" role="tab" aria-controls="pills-item1" aria-selected="true">Thể loại 1</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" id="pills-item3-tab" data-toggle="pill" href="#pills-item3" role="tab" aria-controls="pills-item3" aria-selected="false">Thể loại 3</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-item4-tab" data-toggle="pill" href="#pills-item4" role="tab" aria-controls="pills-item4" aria-selected="false">Thể loại 4</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " id="pills-item5-tab" data-toggle="pill" href="#pills-item5" role="tab" aria-controls="pills-item5" aria-selected="false">Thể loại 5</a>
                </li>
                <li class="nav-item">
                    <a href="{{route('books')}}" class=" nav-link" style=" font-size:15px;;">
                        Tất cả...
