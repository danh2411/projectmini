<footer class="footer section section-sm pd-15">
    <!-- Container Start -->
    <div class="container">
        <div class="row">
...
<footer class="footer-bottom">
    ...
    <!-- mess -->
    <div class="mess">
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="#000" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
    ...
    <!-- mess -->
    <div class="call">
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="#000" class="bi bi-telephone-forward" viewBox="0 0 16 16">
