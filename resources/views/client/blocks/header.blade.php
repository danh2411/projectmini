            ...
            <div class="col-md-12">
                <nav class="navbar navbar-expand-lg navbar-light navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="widget search p-0  ml-auto m-auto search-header d-flex ">
                            <div class="input-group  m-auto ">
                                <input type="text" class="form-control pt-0 pb-0 " id="expire" placeholder="Search...">
                                <span class="input-group-addon bgcolor-home"><i class="fa fa-search px-3"></i></span>
                            </div>
                        </div>
                                ...
                                <div class="header-right-info ">
                                    <ul class="nav navbar-nav mai-top-nav header-right-menu col-lg-5 col-md-5 col-sm-12 col-xs-12 login-button">
                                        ...
                                        @if(!Auth::user())
                                                ...
                                                <a class="nav-link dropdown-toggle m-auto" href="{{route('login')}}">
                                                ...
                                                <!-- <a href="{{route('login')}}"  role="button" aria-expanded="false" class="nav-link dropdown-toggle ">
