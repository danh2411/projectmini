<header class="bg-white header_nav">
    <div class="container ">
        <div class="row">
            <div class="col-md-12 ">
                <nav class="navbar navbar-expand-lg navbar-light navigation ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="Category_nav pl-3 navbar-nav  main-nav " id="nav_header_item1">
                            <div class="Category_logo">
                                ...
                                <div class="dropdown_menu_category ">
                                    ...
                                    <div class="line-list-menu-category" style="width: 9px; border-right: 1px solid #CDCFD0; float: left ;height:100%"></div>
                        ...
                        <!-- search box -->
                        <div class="widget search p-0  m-auto search-header d-flex " id="nav_header_item2">
                            <div class="input-group  m-auto ">
                                <input type="text" class="form-control pt-0 pb-0 search_input " id="expire" placeholder="Search...">
                                <span class="input-group-addon bgcolor-home search_icon"><i class="fa fa-search px-3"></i></span>
                            </div>
                        </div>
                        <!-- search box -->
                            ...
                            <ul class="navbar-nav  main-nav ">
                                ...
                                <div class="   ">
                                    <div class="header-right-info ">
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu col-lg-5 col-md-5 col-sm-12 col-xs-12 login-button">
                                            <li class="nav-item " style="margin-right: 0px;">

                                                @if(!Auth::user())

                                                <a class="nav-link dropdown-toggle m-auto item--hover " href="{{route('login')}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="var(--home)" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                                                ...
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class=" item--hover nav-link dropdown-toggle ">
