...
<section class="section bg-gray">
	...
	<div class="container">
		<div class="row">
			<!-- Left sidebar -->
			<div class="col-lg-8 pd-left-none">
				<div class="product-details">
					...
					<div class="product-slider">
						<div class="product-slider-item my-4" data-image="{{asset('assets/client/images/products/products-1.jpg')}}">
							<img class="img-fluid w-100" src="{{asset('assets/client/images/products/products-1.jpg')}}" alt="product-img">
						</div>
						<div class="product-slider-item my-4" data-image="{{asset('assets/client/images/products/products-2.jpg')}}">
							<img class="d-block img-fluid w-100" src="{{asset('assets/client/images/products/products-2.jpg')}}" alt="Second slide">
						</div>
						<div class="product-slider-item my-4" data-image="{{asset('assets/client/images/products/products-3.jpg')}}">
							<img class="d-block img-fluid w-100" src="{{asset('assets/client/images/products/products-3.jpg')}}" alt="Third slide">
						</div>
						<div class="product-slider-item my-4" data-image="{{asset('assets/client/images/products/products-1.jpg')}}">
							<img class="d-block img-fluid w-100" src="{{asset('assets/client/images/products/products-1.jpg')}}" alt="Third slide">
						</div>
						<div class="product-slider-item my-4" data-image="{{asset('assets/client/images/products/products-2.jpg')}}">
							<img class="d-block img-fluid w-100" src="{{asset('assets/client/images/products/products-2.jpg')}}" alt="Third slide">
						</div>
					</div>
					<!-- product slider -->
...
<!-- js -->
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
								...
								<div class="product-review">
									<div class="media">
										<!-- Avater -->
										<img src="{{asset('assets/client/images/user/user-thumb.jpg')}}" alt="avater">
 ...
 <!-- js -->
			...
			<div class="col-lg-4 pd-right-none">
				<div class="sidebar">
