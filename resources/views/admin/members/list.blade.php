                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onclick="return confirm('Bạn có muốn xóa thể loại này không ?')" data-toggle="tooltip" title="hide" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                </td>
                            </tr>
                        </table>
                    </div>
