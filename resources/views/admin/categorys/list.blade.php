                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button onclick="return confirm('Bạn có muốn xóa danh mục này không ?')" data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                </td>
                            </tr>
                        </table>
                    </div>
